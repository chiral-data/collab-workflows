"""HTML Generator for Node 06: Differential Diagnosis Biomarkers
...
<body>
    <div class="container">
        ...
        <footer>
            ...
            <p><strong>Node:</strong> 06 - Differential Diagnosis Biomarkers</p>
        </footer>
    </div>
    ...
    <script>
        ...
        async function init() {{
            try {{
                const response = await fetch('biomarkers_data.json');
                if (!response.ok) {{
                ...
                document.getElementById('app').innerHTML = `
                    <div class="error">
                        ...
                        <p><strong>File:</strong> biomarkers_data.json</p>
