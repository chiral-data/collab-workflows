...
def generate_metabolic_load_html(json_filename='metabolic_load_data.json'):
    """Generate HTML for Global Metabolic Load Analysis visualization"""
...
<body>
    <div class="container">
        ...
        <footer>
            ...
            <p><strong>Node:</strong> 08 - Global Metabolic Load Analysis</p>
        </footer>
    </div>
    ...
    <script>
        ...
        async function init() {{
            try {{
                const response = await fetch('metabolic_load_data.json');
                if (!response.ok) {{
                ...
                document.getElementById('app').innerHTML = `
                    <div class="error">
                        ...
                        <p><strong>File:</strong> metabolic_load_data.json</p>
