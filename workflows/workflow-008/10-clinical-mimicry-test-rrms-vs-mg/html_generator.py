"""HTML Generator for Node 10: Clinical Mimicry Dashboard (Python 3)
Generates interactive HTML visualization matching Node 4/6/8 style.
"""

import json
import os

def generate_mimicry_html(json_filename: str = 'mimicry_data.json') -> str:
...
<body>
    ...
    <div class="controls">
        <label style="font-weight:600; color:#555; margin-right:5px;">View:</label>
        <div class="tab-group">
            <button class="tab-btn active" onclick="switchTab('fig10')">Total Overview</button>
            <button class="tab-btn" onclick="switchTab('fig11')">Detailed Analysis</button>
        </div>
        ...
        <div class="legend-bar">
            <div class="legend-item"><span class="dot" style="background:#808080"></span> RRMS</div>
    ...
    <script>
        ...
        function switchTab(tab) {{
            ...
            if(tab === 'fig10') document.querySelector('.tab-btn:first-child').classList.add('active');
